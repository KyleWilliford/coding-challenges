...
class Solution:
    ...
    def twoSum_2(self, nums: List[int], target: int) -> List[int]:
        ...
        for i in range(len(nums)):
            n = nums[i]
            if target - n in ind_dict.keys():
                return [ind_dict[target - n], i]
            ind_dict[n] = i
